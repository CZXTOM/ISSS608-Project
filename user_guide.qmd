...
The main screen. The numbered labels mark the round slider, the System Health gauge, the mode switch, and the workbook button.
:::
...
::: {.gb-shot}
![The Case screen with the System Health line across 23 rounds, a low point clicked, and a panel describing what happened that round.](images/ug-03-case.png)
...
2. Use the centrality switch to change what node size and colour mean, since each
   measure answers a different question.
3. Use the time window to compare the calm weeks against the crisis day.
4. Click an agent to highlight its connections.

::: {.gb-shot}
![The Network screen with the seven agents as nodes, sized and coloured by centrality, and the controls to switch measure and time window.](images/ug-05-network.png)

The Network screen. The agents who brokered the decisions sit at the centre, not the edges.
:::
